 ...
 */
const STRONG =
  /주택|부동산|아파트|청약|전세(?!계(?!약))|월세|임대|재개발|재건축|정비사업|분양|택지|양도세|종부세|취득세|공시가격|실거래|집값|GTX|역세권|중개|규제지역|거래허가|토지|DSR|LTV|신도시|공급대책|주거|영끌|주담대|빌라|오피스텔|다세대|연립주택|단독주택|입주권|분양권|조합원|분담금|전월세|보증금|특별공급|청약통장|갭투자|전용면적|보유세|재산세|공시지가/;
