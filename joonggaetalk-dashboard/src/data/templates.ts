...
/**
 * 알림톡이 카카오톡으로 꽂히지 않을 때 대신 나갈 문자.
 * 알림톡 요청에 같이 실려 나가므로 템플릿에 딸려 있어야 한다.
 * 카카오 검수 대상이 아니라 승인 없이 고칠 수 있다.
 */
export type SmsFallback = { enabled: boolean; body: string };
...
export const templates: Template[] = [
  { id: "t1", name: "[부동산TALK] 신규", body: "#{고객명}님, 안녕하세요.\n#{중개사상호}입니다. 고객으로 등록해 주셔서 감사합니다.\n계약 일정과 물건 정보를 알림톡으로 안내해 드립니다.", buttons: ["오시는길", "네이버부동산"], status: "승인", shared: true, createdAt: "2026-06-24", usedBy: "고객등록", sms: { enabled: false, body: "[서연공인중개사사무소]\n#{고객명}님, 안녕하세요.\n고객으로 등록해 주셔서 감사합니다. 계약 일정과 물건 정보를 안내해 드리겠습니다." } },
  { id: "t2", name: "[부동산TALK] 계약일정", body: "#{고객명}님, #{물건명} 계약일이 #{계약일}입니다.\n신분증과 도장을 준비해 주세요.\n문의: #{사무실 전화}", buttons: ["오시는길"], status: "승인", shared: true, createdAt: "2026-06-24", usedBy: "계약일 1일 전", sms: { enabled: true, body: "[서연공인중개사사무소]\n#{고객명}님, #{물건명} 계약일이 #{계약일}입니다.\n신분증과 도장을 준비해 주세요.\n문의: #{사무실 전화}" } },
  { id: "t3", name: "[부동산TALK] 중도금 도래", body: "#{고객명}님, #{물건명} 중도금일이 #{중도금일}입니다.\n입금 계좌를 다시 한번 확인해 주세요.", buttons: [], status: "승인", shared: true, createdAt: "2026-06-24", usedBy: "중도금일 1일 전", sms: { enabled: true, body: "[서연공인중개사사무소]\n#{고객명}님, #{물건명} 중도금일이 #{중도금일}입니다.\n입금 계좌를 다시 한번 확인해 주세요.\n문의: #{사무실 전화}" } },
  { id: "t4", name: "잔금일", body: "#{고객명}님, #{물건명} 잔금일 #{잔금일} 안내드립니다.\n당일 확정일자·전입신고를 함께 진행합니다.", buttons: ["오시는길"], status: "승인", shared: false, createdAt: "2026-07-11", usedBy: "잔금일 3일 전", sms: { enabled: true, body: "[서연공인중개사사무소]\n#{고객명}님, #{물건명} 잔금일 #{잔금일} 안내드립니다.\n당일 확정일자·전입신고를 함께 진행합니다.\n문의: #{사무실 전화}" } },
  { id: "t5", name: "[부동산TALK] 입주 후 알림", body: "#{고객명}님, 입주 한 달이 지났습니다. 불편한 점은 없으신가요?\n#{중개사상호}가 계속 도와드리겠습니다.", buttons: ["홈페이지"], status: "승인", shared: true, createdAt: "2026-06-25", usedBy: "입주일 30일 후" },
  { id: "t6", name: "[부동산TALK] 계약 만료일", body: "#{고객명}님, #{물건명} 계약 만료일이 #{계약만료일}입니다.\n재계약 또는 이사 계획을 미리 상의해 주세요.", buttons: ["오시는길"], status: "승인", shared: true, createdAt: "2026-06-24", usedBy: "임대차 만료일 90일 전", sms: { enabled: true, body: "[서연공인중개사사무소]\n#{고객명}님, #{물건명} 계약 만료일이 #{계약만료일}입니다.\n재계약 또는 이사 계획을 미리 상의해 주세요.\n문의: #{사무실 전화}" } },
  { id: "t7", name: "등기부 변동 알리미", body: "[부동산TALK 무료 안심 서비스]\n#{고객명}님, #{물건주소} 등기부에 변동이 확인되었습니다. 자세한 내용은 #{중개사상호}로 문의해 주세요.", buttons: ["전화하기"], status: "승인", shared: true, createdAt: "2026-07-11", usedBy: "등기부 변동 당일", sms: { enabled: true, body: "[서연공인중개사사무소]\n#{고객명}님, #{물건주소} 등기부에 변동이 확인되었습니다.\n자세한 내용은 사무실로 문의해 주세요.\n#{사무실 전화}" } },
