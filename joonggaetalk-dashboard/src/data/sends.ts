...
export const sendBatches: SendBatch[] = [
  ...
  { id: "b-up3", kind: "자동발송", templateId: "t3", templateName: "[부동산TALK] 중도금 도래", trigger: "중도금일 1일 전", dealName: "청라 한양수자인 205동 1502호 매매", scheduledAt: "2026-09-24 09:00", total: 1, success: 0, failed: 0, pending: 1, costPerMsg: 6.5, items: [{ customerId: "c002", customerName: "김민수", phoneMasked: "010-****-2201", status: "예정" }] },
  { id: "b-up4", kind: "자동발송", templateId: "t6", templateName: "[부동산TALK] 계약 만료일", trigger: "임대차 만료일", dealName: "판교 오피스텔 1203호 월세", scheduledAt: "2026-09-26 09:00", total: 1, success: 0, failed: 0, pending: 1, costPerMsg: 6.5, items: [{ customerName: "한서윤", phoneMasked: "010-****-9013", status: "예정" }] },
  ...
  { id: "b2", kind: "환영인사", templateId: "t1", templateName: "[부동산TALK] 신규", trigger: "고객 등록", scheduledAt: "2026-09-12 20:36", finishedAt: "2026-09-12 20:36", total: 2, success: 0, failed: 2, pending: 0, costPerMsg: 6.5, fallback: { sent: 0, cost: 0 }, items: [ng("정관영", "3402", "vendor_ssl"), ng("이데아", "7712", "vendor_ssl")] },
  // 최근 완료
  ...
  { id: "b4", kind: "환영인사", templateId: "t1", templateName: "[부동산TALK] 신규", trigger: "고객 등록", scheduledAt: "2026-09-11 12:12", finishedAt: "2026-09-11 12:12", total: 1, success: 1, failed: 0, pending: 0, costPerMsg: 6.5, items: [ok("정하은", "0352")] },
  ...
  { id: "b8", kind: "지금 발송", templateId: "t10", templateName: "부동산TALK 회원 알림", scheduledAt: "2026-09-07 11:05", finishedAt: "2026-09-07 11:06", total: 163, success: 161, failed: 2, pending: 0, costPerMsg: 6.5, items: [ok("김진년", "2210"), ok("김태이", "9908"), ng("공진희", "3311", "invalid_number"), ng("권리원", "8823", "invalid_number")] },
  { id: "b9", kind: "환영인사", templateId: "t1", templateName: "[부동산TALK] 신규", trigger: "고객 등록", scheduledAt: "2026-09-07 20:35", finishedAt: "2026-09-07 20:41", total: 75, success: 75, failed: 0, pending: 0, costPerMsg: 6.5, items: [ok("변영균", "1102"), ok("유천", "1303")] },
  { id: "b10", kind: "자동발송", templateId: "t2", templateName: "[부동산TALK] 계약일정", trigger: "계약일 1일 전", dealName: "청라 한양수자인 205동 1502호 매매", scheduledAt: "2026-08-30 09:00", finishedAt: "2026-08-30 09:00", total: 2, success: 2, failed: 0, pending: 0, costPerMsg: 6.5, items: [ok("김민수", "2201"), ok("오지민", "5570")] },
  // 대체발송을 켜기 전에 나간 건. 알림톡으로 다시 보내도 결과가 같아 문자로만 덮을 수 있다.
  { id: "b13", kind: "자동발송", templateId: "t6", templateName: "[부동산TALK] 계약 만료일", trigger: "임대차 만료일 90일 전", dealName: "부천 중동 신축빌라 302호 전세", scheduledAt: "2026-08-24 09:00", finishedAt: "2026-08-24 09:00", total: 2, success: 1, failed: 1, pending: 0, costPerMsg: 6.5, items: [ok("정하은", "0352"), ng("서동혁", "6614", "no_kakao")] },
  { id: "b12", kind: "자동발송", templateId: "t2", templateName: "[부동산TALK] 계약일정", trigger: "계약일 1일 전", dealName: "계산동 상가 1층 임대차", scheduledAt: "2026-09-05 09:00", finishedAt: "2026-09-05 09:00", total: 3, success: 1, failed: 2, pending: 0, costPerMsg: 6.5, fallback: { sent: 2, cost: 100 }, items: [ok("이수현", "1120"), sms("최영호", "7245", "no_kakao", "LMS", "2026-09-05 09:00"), sms("장미경", "3391", "kakao_blocked", "LMS", "2026-09-05 09:00")] },
