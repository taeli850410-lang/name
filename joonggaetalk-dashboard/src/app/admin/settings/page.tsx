            ...
            <section className="card">
              ...
              <div className="card__body form" style={{ maxWidth: 560 }}>
                ...
                <div className="form-grid-2">
                  ...
                  <div className="field"><label className="label" htmlFor="su-admin">알림 받을 운영자</label><select id="su-admin" className="select" defaultValue="이서연" onChange={mark}><option>이서연 (서연공인중개사사무소)</option><option>박준서 (부동산TALK 운영팀)</option></select><div className="help">텔레그램을 붙이면 이 운영자에게 갑니다. 아직 연결 전이라 지금은 대시보드에만 뜹니다.</div></div>
                </div>
