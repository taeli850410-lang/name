        ...
        <div className="stack" style={{ gap: 16 }}>
          ...
          {tab === "keys" && (
            <>
              ...
              <section className="card"><div className="card__head"><h2>국토교통부 실거래가 API</h2><Badge tone="good" dot>연결 확인 09-12</Badge></div><div className="card__body form" style={{ maxWidth: 640 }}><SecretField id="molit-key" label="인증키 (Decoding)" hint="data.go.kr에서 발급. API 호출에 쓰입니다. 지원 12종: 아파트·연립다세대·단독다가구·오피스텔(매매·전월세) / 토지·상업업무용·분양입주권·공장창고(매매)" value="••••••••••••••••••••••••" onDirty={mark} /><div className="field"><label className="label" htmlFor="molit-limit">기본 조회 제한 건수</label><input id="molit-limit" className="input" inputMode="numeric" defaultValue="2000" onChange={mark} /></div></div></section>
